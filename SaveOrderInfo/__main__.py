...
def main(params):
    ...
    orderResult = Order(dictText_1.get("id"),dictText_1.get("boughtDate"),dictText_1.get("travelDate"),dictText_1.get("travelTime"),dictText_1.get("accountId"),dictText_1.get("contactsName"),dictText_1.get("docType"),dictText_1.get("docNum"),dictText_1.get("trainNum"),dictText_1.get("coachNum"),dictText_1.get("seatClass"),dictText_1.get("seatNum"),dictText_1.get("stFrom"),dictText_1.get("stTo"),dictText_1.get("stat"),dictText_1.get("price"))
    ...
    myclient.hset("trainNum",orderId,orderResult.trainNum)
